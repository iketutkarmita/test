                            ...
                            <div class="col-lg-8 col-md-7"
                                ...
                                <div class="slider-product-content">
                                    <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s">
                                        <span>short</span> <span> sleeves</span> <span>shirt</span>
                                    </h1>
                                    <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">This shirt is
                                        made in Indonesia<br> and 50% discount let's buy.</p>
                                    <a class="main-btn" href="/post" data-animation="fadeInUp" data-delay="1.5s"
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <div class="collection-menu text-center mt-30">
                        <h4 class="collection-tilte FrontendVue">OUR PRODUCT</h4>
                                            ...
                                            <div class="col-md-4">
                                                <div class="single-product-items">
                                                    ...
                                                    <div class="product-item-content text-center mt-30">
                                                        <h5 class="product-title"><a href="#">{{ $p->nama }}</a>
                                                        </h5>
                                                        <ul class="rating">
                                        ...
                                        @foreach ($Produk as $p)
                                            <div class="col-md-4">
                                                <div class="single-product-items">
                                                    ...
                                                    <div class="product-item-content text-center mt-30">
                                                        <h5 class="product-title"><a href="#"></a>{{ $p->nama }}
                                                        </h5>
                                                        <ul class="rating">
                                                            <li><i class="lni-star-filled"></i></li>
                                                            <li><i class="lni-star-filled"></i></li>
